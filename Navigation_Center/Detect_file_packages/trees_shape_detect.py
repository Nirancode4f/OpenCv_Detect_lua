...
# cv.createTrackbar("min-S", "remove_white", 0, 255, nothing)
# cv.createTrackbar("min-V", "remove_white", 0, 255, nothing)
#
# cv.createTrackbar("max-H", "remove_white", 255, 255, nothing)
# cv.createTrackbar("max-S", "remove_white", 116, 255, nothing)
# cv.createTrackbar("max-V", "remove_white", 154, 255, nothing)
